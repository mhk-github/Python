...
class MPSMainWindow(QWidget):
        ...
        if file_name:
            ...
            try:
                ...
                if not self.mps:
                    ...
                    self._layout.addWidget(details_button, 1, 0, 1, 1)
                    self._layout.addWidget(structure_button, 2, 0, 1, 1)
    ...
    def click_details(self) -> None:
        ...
        mb = QMessageBox()
        mb.setWindowTitle(f"Details - {PurePath(self._file_name).name}")
        mb.setText(
            f"Name : '{self.mps.name}'\n\n"
            f"Rows     : {len(self.mps.rows):9,d}\n"
            f"Columns  : {len(self.mps.columns):9,d}\n"
            f"Elements : {len(self.mps.elements):9,d}\n\n"
            f"RHS    ? {bool(self.mps.rhs)}\n"
            f"Ranges ? {bool(self.mps.ranges)}\n"
            f"Bounds ? {bool(self.mps.bounds)}"
        )
        mb.setStandardButtons(QMessageBox.Ok)
        mb.exec_()
    ...
    def click_structure(self) -> None:
        ...
        cw = MPSStructureWindow(self, self._file_name)
        cw.show()
    ...
    def click_histogram_absolute_element_values(self) -> None:
        ...
        hw = AbsoluteValuesHistogramWindow(self, self._file_name)
        hw.show()
    ...
    def click_histogram_row_tallies(self) -> None:
        ...
        hw = RowTalliesHistWindow(self, self._file_name)
        hw.show()
    ...
    def click_histogram_column_tallies(self) -> None:
        ...
        hw = ColumnTalliesHistWindow(self, self._file_name)
        hw.show()
    ...
    def closeEvent(self, event: QEvent) -> None:
        ...
        active_refs = list(self._child_window_refs)
    ...
    def add_child_ref(self, child: Qwidget) -> None:
        ...
        self._child_window_refs.add(child)
    ...
    def remove_child_ref(self, child: Qwidget) -> None:
        ...
        self._child_window_refs.remove(child)
